    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-on-surface-variant">Accede a tus mazos guardados</p>
        </div>

        <form onSubmit={handleLogin} className="bg-surface-container-low rounded-2xl p-6 border border-outline-variant/20 shadow-sm">
          {error && (
